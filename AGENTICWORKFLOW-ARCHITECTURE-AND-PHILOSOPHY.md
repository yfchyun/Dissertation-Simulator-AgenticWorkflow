...
graph TB
    subgraph "AgenticWorkflow 코드베이스 (설계 프레임워크)"
        ...
        subgraph "Context Preservation + Safety"
            CPS["hooks/scripts/<br/>42개 프로덕션 + 2개 모듈 + 22개 테스트 스크립트<br/>(CP 6 + Safety 6 + Validation 15 + Obs/Diag 2 + Thesis 8 + P1 Utility 7 + Setup 2<br/>+ Abductive Diagnosis Layer + Thesis P1 Deterministic 6)"]
